...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "RS";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "REDSTONE";
    ...
    const std::string daemonName = "RedStoneCoin";
    ...
    const std::string contactLink = "https://www.red-stone.me/";
